...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login/sms", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.SMSLogin)
			userRoute.POST("/sms/send", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.SMSVerificationRateLimit(), controller.SendSMSCode)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/phone/bind", controller.BindPhone)
